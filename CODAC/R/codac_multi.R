...
codac_multi <- function(data,
  ...
  script_path <- system.file("python", "CODAC_Multi_Py.py", package = "CODAC")

  if (script_path == "") {
    stop("[ERROR] Python script not found. Ensure 'CODAC_Multi_Py.py' is in the 'inst/python' folder.")
  }

  message("\n[INFO] Starting the CODAC_Multi Pipeline via Python engine...")
  ...
  message("[SUCCESS] CODAC_Multi Pipeline finished successfully!")
