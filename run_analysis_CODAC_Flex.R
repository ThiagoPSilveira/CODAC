...
# and EVERY target is skipped as "insufficient valid data" - so if you see that,
...
analysis_results <- codac_flex(
  ...
  targets_to_plot   = c("Tbc1d16","Scd1","Gsta3","Pzp","Chchd10","P4hb","Tle5","Txn1","C8g","Hspa8","Atp5j","Orm1","Rps12"),  # Target(s) to plot, e.g. c("Per2", "Arntl")
